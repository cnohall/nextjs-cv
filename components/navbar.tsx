    ...
    <Navbar variant='dark'>
        <Container >
            ...
            <Nav className="m-auto">       
              <Link href="/" passHref><Nav.Link>{t('common:home')}</Nav.Link></Link>
              <Link href="/work" passHref><Nav.Link>{t('common:work')}</Nav.Link></Link>
              <Link href="/writing" passHref><Nav.Link>{t('common:writing')}</Nav.Link></Link>
              <Link href="/projects" passHref><Nav.Link>{t('common:projects')}</Nav.Link></Link>
              <Link href="/contact" passHref><Nav.Link>{t('common:contact')}</Nav.Link></Link>
